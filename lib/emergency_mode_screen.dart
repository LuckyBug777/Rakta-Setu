    ...
    if (snapshot.docs.isNotEmpty) {
      ...
      setState(() {
        for (int i = 0; i < _nearbyDonors.length; i++) {
          ...
          final isResponding = respondingDonors
              .any((responder) => responder['phone'] == donor['phone']);
    ...
    try {
      for (final donor in _nearbyDonors) {
        ...
        final notificationData = {
          ...
          'message':
              'Urgent: ${_currentUserName} needs ${_currentUserBloodGroup} blood in $_currentUserDistrict. Please respond if you can help!',
          'createdAt': Timestamp.now(),
          'isRead': false,
